...
<head>
    ...
    <title>Login Page | DP3AP2KB</title>

    <meta name="description" content="" />

    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="<?= base_url('landingpage/') ?>assets/img/logo_tanah_laut.png" />
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                <img src="<?= base_url('landingpage/') ?>assets/img/logo1.png" alt="logo" width="150" />
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">Selamat Datang 👋</h4>
                        <p class="mb-4">Silahkan Login Terlebih Dahulu</p>
                        <?php // Validation errors (from controller -> with('errors', ...)) ?>

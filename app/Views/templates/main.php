...
<head>
    ...
    <title>CMS | DP3AP2KB</title>

    <meta name="description" content="" />
    <?= $this->renderSection('meta') ?>
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="<?php echo base_url(); ?>assets/img/favicon/logo2.png" />
    <!-- Fonts -->
    ...
    <link rel="stylesheet"
        href="<?php echo base_url(); ?>assets/vendor/libs/datatables-buttons-bs5/buttons.bootstrap5.css">
